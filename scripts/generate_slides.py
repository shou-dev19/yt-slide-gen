...
<head>
  ...
  <style>
    ...
    /* 評価ペア N-0 の料金表 */
    .plan-table td:nth-child(2) { font-weight: 900; }
    .plan-table .packet-service { color: var(--brand-deep); font-weight: 900; }
...
""")
    ...
    # 21-2. Slide 15-0 (見開き, price-note - 評価ペア: レーダーチャート＋料金プラン。§3 により 15 とセットで必須)
    slides_html.append("""  <!-- Slide ID: 15-0 -->
  <div class="slide-container price-note" style="--brand:#22a73f;--brand-deep:#1c8b34;--brand-soft:#e8f5e6;">
    <div class="book">
      <div class="spine"></div>
      <div class="page left">
        ...
        <div class="page-body">
          <div class="visual">
            <img src="public/images/charts/mineo.png" alt="mineoの6観点評価レーダーチャート">
          </div>
        </div>
      </div>
      <div class="page right">
        <div class="page-head">mineoの料金プラン</div>
        <div class="page-body">
          <table class="sheet plan-table">
            <thead>
              <tr><th>コース</th><th>月額</th><th>無料の使い放題</th></tr>
            </thead>
            <tbody>
              <tr><td>3GB</td><td>1,298円</td><td class="packet-service" rowspan="2">1Mbps</td></tr>
              <tr><td>7GB</td><td>1,518円</td></tr>
              <tr><td>15GB</td><td>1,958円</td><td class="packet-service" rowspan="3">3Mbps</td></tr>
              <tr><td>30GB</td><td>2,178円</td></tr>
              <tr><td>50GB</td><td>2,948円</td></tr>
            </tbody>
          </table>
          <div class="note">※マイピタ（音声通話付き）</div>
        </div>
      </div>
    </div>
  </div>
