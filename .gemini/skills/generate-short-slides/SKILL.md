...
- **Rule**: Eliminate long sentences. Extract only the shortest, most impactful phrases ("30GB", "たったの2,970円", "通話無料") from the script.
...
- **Icon/Image**: Shocked expression illustration (`animal_buta_shock_etc`).
...
- **Placeholder**: A large image placeholder / `<img>` tag at the bottom for the main YouTube video thumbnail with a blue thick border.
