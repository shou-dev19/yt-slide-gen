---
name: replace-slide-images
description: Replace placeholder images in slide HTML files with actual image assets from the public/images directory.
---

# Replace Slide Images Skill

This skill automates the process of replacing temporary or placeholder images (e.g., from `placehold.co`) in your slide HTML file (usually `public/スライド.html`) with the correct local image assets located in `public/images/`.
...
2.  **Analyze Slide HTML**:
    -   Read the target HTML file (e.g., `public/スライド.html`).
