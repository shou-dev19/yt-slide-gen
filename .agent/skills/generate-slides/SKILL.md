...
description: Generate a React component for slides based on a script file, using placeholders for images.
---
...
const cssStyles = `
  ...
  /* ... (Include standardized CSS from previous SKILL.md for consistency) ... */
  ...
  /* New Utility Classes */
  .text-large p, .text-large li { font-size: 80px; } /* Increased font size for dense slides */
